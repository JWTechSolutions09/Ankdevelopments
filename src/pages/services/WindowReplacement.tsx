...
import { ArrowRight, Phone, CheckCircle, Home, Award, Clock, Users } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Expert installation by skilled craftsmen",
    },
    {
      icon: <Award className="h-6 w-6" />,
      title: "Quality Materials",
      description: "Premium windows and materials",
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Why Choose Our Window Replacement
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional window replacement services you can trust
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white mb-8">
                We offer comprehensive window replacement services to enhance your home's comfort and appearance.
              </p>
