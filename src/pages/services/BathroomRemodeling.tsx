  ...
  const features = [
    {
      ...
      title: "Luxury Design",
      description: "Premium fixtures and elegant finishes",
    },
    {
      icon: <Award className="h-6 w-6" />,
      title: "Quality Materials",
      description: "Top-grade tiles, vanities, and fixtures",
    },
    {
    ...
    <div className="min-h-screen bg-[#0f172a]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Why Choose Our Bathroom Remodeling
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional bathroom renovation services you can trust
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-white via-gray-50 to-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Ready to Remodel Your Bathroom?</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
            ...
            <Button asChild size="lg" variant="outline" className="bg-gray-900 text-white hover:bg-gray-800 border-2 border-gray-900 text-lg px-10 py-6 font-bold">
