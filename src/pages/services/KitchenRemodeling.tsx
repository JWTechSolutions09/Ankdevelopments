...
const KitchenRemodeling = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#9ba5c8] via-[#8a95b8] to-[#9ba5c8] py-20 lg:py-32 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white space-y-6">
              <div className="inline-block">
                <span className="bg-[#fcd47a] text-[#9ba5c8] px-4 py-2 rounded-full text-sm font-bold uppercase tracking-wide">
                  Kitchen Remodeling
                </span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  asChild
                  size="lg"
                  className="bg-[#fcd47a] text-[#9ba5c8] hover:bg-[#fcd47a] text-lg px-8 py-6 font-bold shadow-lg hover:shadow-xl transition-all"
                >
            ...
            <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              <div className="absolute inset-0">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#9ba5c8]/60 to-transparent"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-[#9ba5c8] mb-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="border-2 border-gray-200 hover:border-[#9ba5c8] transition-all hover:shadow-xl text-center"
              >
                <CardContent className="p-6">
                  <div className="bg-[#fcd47a]/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                    <div className="text-[#9ba5c8]">{feature.icon}</div>
                  </div>
                  <h3 className="text-xl font-bold text-[#9ba5c8] mb-2">
                    {feature.title}
                  </h3>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-[#9ba5c8] mb-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                {services.map((service, index) => (
                  <div key={index} className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-[#fcd47a] mt-0.5 flex-shrink-0" />
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-[#9ba5c8] via-[#8a95b8] to-[#9ba5c8]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              asChild
              size="lg"
              className="bg-[#fcd47a] text-[#9ba5c8] hover:bg-[#fcd47a] text-lg px-10 py-6 font-bold shadow-xl hover:shadow-2xl transition-all"
            >
