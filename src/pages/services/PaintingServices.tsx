...
import { ArrowRight, Phone, CheckCircle, Paintbrush, Award, Clock, Users } from "lucide-react";
  ...
  const features = [
    {
      ...
      title: "Quality Paint",
      description: "Premium paint materials and finishes",
    },
    {
      icon: <Award className="h-6 w-6" />,
      title: "Professional Finish",
      description: "Clean, professional painting results",
    },
    {
    ...
    <div className="min-h-screen bg-[#0f172a]">
      ...
      <section className="py-20 bg-gradient-to-b from-[#0f1b2e] via-[#1a2f4a] to-[#1e3a5f] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Our Painting Services</h2>
              <p className="text-lg text-white mb-8">
                We offer comprehensive painting services to refresh and protect your home.
              </p>
