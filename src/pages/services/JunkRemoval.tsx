...
import { ArrowRight, Phone, CheckCircle, Trash2, Award, Clock, Users } from "lucide-react";
...
const JunkRemoval = () => {
  ...
  const images = [
    "/images/Junk Removal.jpeg",
    "/images/Junk Removal2.jpeg",
  ];
  ...
  const features = [
    {
      ...
      description: "Fast and efficient removal service",
    },
    {
    ...
    },
    {
      ...
      description: "We respond quickly to your needs",
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "Professional Team",
      description: "Experienced and reliable crew",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-white mb-8">
                We offer comprehensive junk removal services to clear your space quickly and efficiently.
              </p>
