...
const Navbar = () => {
  ...
  return (
    <nav className={`navbar-ak sticky top-0 z-50 bg-[#0f172a] border-b-2 border-[#3b82f6]/40 transition-all duration-300 ${scrolled ? 'shadow-xl shadow-[#3b82f6]/20' : 'shadow-lg'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="lg:hidden flex items-center">
            <Button
              ...
              className="text-white hover:bg-[#3b82f6]/30 bg-[#1e293b]/50 p-3 rounded-lg transition-all border border-[#3b82f6]/30"
        ...
        {/* Mobile Navigation */}
        {isOpen && (
          <div className="lg:hidden py-6 px-4 border-t-2 border-[#3b82f6]/60 animate-fade-in-up bg-[#0f172a] shadow-2xl backdrop-blur-md">
            <div className="flex flex-col space-y-3">
                ...
                return (
                  <Link
                    ...
                    className={`px-4 py-3 rounded-lg text-base font-medium transition-colors flex items-center gap-3 ${
                      isActive(item.path)
                        ? "bg-gradient-to-r from-[#2563eb] to-[#1e40af] text-white font-semibold shadow-lg"
                        : "text-gray-200 hover:bg-[#3b82f6]/30 hover:text-white bg-[#1e293b]/60"
                    }`}
                  >
              ...
              <Button
                asChild
                className="mt-4 bg-[#fbbf24] hover:bg-[#fcd34d] text-[#0f172a] w-full py-4 font-bold shadow-xl hover:shadow-2xl transition-all hover:scale-105 border-2 border-[#fbbf24]"
                onClick={() => setIsOpen(false)}
              >
