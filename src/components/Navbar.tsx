...
const Navbar = () => {
  ...
  return (
    <nav className={`navbar-ak sticky top-0 z-50 bg-[#0f172a] border-b border-[#60a5fa]/20 transition-all duration-300 ${scrolled ? 'shadow-lg shadow-[#60a5fa]/10' : 'shadow-md'}`}>
        ...
        <div className="flex justify-between items-center h-20">
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-lg sm:text-xl font-bold text-[#60a5fa] leading-tight group-hover:text-[#3b82f6] transition-colors">
                A&K DEVELOPMENT
              </span>
              ...
              return (
                <Link
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 flex items-center gap-2 ${
                    isActive(item.path)
                      ? "bg-gradient-to-r from-[#60a5fa] to-[#3b82f6] text-white font-semibold shadow-md"
                      : "text-gray-700 hover:bg-[#fbbf24]/20 hover:text-[#60a5fa]"
                  }`}
                >
